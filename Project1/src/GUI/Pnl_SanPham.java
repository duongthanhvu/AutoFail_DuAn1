...
public class Pnl_SanPham extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cbb_LoaiSanPham.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Dinh dưỡng phụ nữ mang thai", "Dinh dưỡng trẻ em", "Dinh dưỡng người lớn", "Dinh dưỡng chuyên biệt" }));
        ...
        lbl_SoDienThoai.setText("Giá bán lẻ");
        ...
        lbl_NgayTao.setText("Tình trạng");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(cbb_LoaiSanPham, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(39, 39, 39)
    ...
    private void capNhatDanhSachSP() {
        ...
        pnl_bg.removeAll();
        DTO.DTOSanPham[] sp = DAL.DALSanPham.layDuLieu();
        for (int i = 0; i < sp.length; i++) {
            JPanel card = new SanPham_ChiTiet(sp[i].getMaSP());
            pnl_bg.add(card);
